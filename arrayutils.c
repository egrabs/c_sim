...
char* addToArray(void* array, int length, int numItems, void* to_add, int sizeOfItem) {
    char* newArray;
    if (length == numItems) {
...
void clearArray(void* array, int length, int sizeOfItem) {
...
static char* resizeArray(void* array, int length) {
